  ...
  return (
    <div className="p-6 bg-white text-black min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 text-sm">
        ...
        <Select onValueChange={(value) => setFormData({ ...formData, phase: value })}>
          <SelectTrigger>
        ...
        <Select onValueChange={(value) => setFormData({ ...formData, week: value })}>
          <SelectTrigger>
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 mb-6">
        ...
        />
        <Button onClick={handleCreate} className="bg-green-500 hover:bg-orange-600 text-white">
          Create
        </Button>
      </div>
                  ...
                  <td className="px-4 py-2">
                    <span
                      ...
                      className={`cursor-pointer px-2 py-1 text-xs rounded ${
                        session.status === "Active" ? "bg-green-500 text-white" : "bg-red-500 text-white"
                      }`}
                    >
                      {session.status}
                    </span>
