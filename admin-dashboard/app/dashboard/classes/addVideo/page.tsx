        ...
        <Card className="shadow border-gray-200">
          <CardContent className="space-y-6 p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="courseTitle" className="mb-1 block">Selected Course</Label>
                <Select
              ...
              <div>
                <Label htmlFor="phaseTitle" className="mb-1 block">Selected Phase</Label>
                <Select
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="weekTitle" className="mb-1 block">Selected Week</Label>
                <Select
              ...
              <div>
                <Label htmlFor="classTitle" className="mb-1 block">Selected Class</Label>
                <Select
            ...
            <div>
              <Label htmlFor="videoTitle" className="mb-1 block">Class Video Title</Label>
              <Input
                id="videoTitle"
                name="videoTitle"
                type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="videoUrl" className="mb-1 block">Video Link</Label>
                <Input
                  id="videoUrl"
                  name="videoUrl"
                  type="text"
              ...
              <div>
                <Label htmlFor="videoLength" className="mb-1 block">Video Length (min)</Label>
                <Input
                  id="videoLength"
                  name="videoLength"
                  type="number"
            ...
            <div className="flex justify-end pt-4">
              <Button className="bg-green-500 hover:bg-orange-600 text-white" type="submit">
                Save & Next →
              </Button>
            </div>
          </CardContent>
