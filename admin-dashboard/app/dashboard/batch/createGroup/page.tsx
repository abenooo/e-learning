    ...
    <div className="p-6 text-black bg-white min-h-screen">
      ...
      <form className="bg-white p-6 rounded shadow border border-gray-200 space-y-5 text-sm">
        ...
        <div>
          ...
          <Select onValueChange={val => setFormData(prev => ({ ...prev, selectedCourse: val }))}>
        ...
        <div>
          ...
          <Select onValueChange={val => setFormData(prev => ({ ...prev, selectedBatch: val }))}>
            <SelectTrigger className="w-full">
        ...
        <div>
          ...
          <Select onValueChange={val => setFormData(prev => ({ ...prev, classDay: val }))}>
            <SelectTrigger className="w-full">
