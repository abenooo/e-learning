...
export default function Dashboard() {
  ...
  return (
    <div className={`${theme} min-h-screen bg-white text-gray-900 relative overflow-hidden`}>
              ...
              <Card className="bg-white border border-gray-200 shadow-sm overflow-hidden">
                <CardHeader className="border-b border-gray-200 pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline" className="bg-white-100 text-green-700 border border-blue-300 text-xs">
...
function DashboardSection({
  ...
  return (
    <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm overflow-hidden">
      <CardHeader className={`${compact ? 'pb-2' : 'pb-3'} border-b border-slate-700/50`}>
        <div className="flex items-center justify-between">
